...
All types are encoded into a continuous latent space.  The GNN
(ResidualPhyloDAE) operates in this space without modification.
Type-specific logic appears only at encoding, loss computation, and
decoding.
