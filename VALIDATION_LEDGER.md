...
| One recommendation from `suggest_next_observation()` improves realised follow-up imputation over random acquisition | Formula and unit tests exist; Stage-A controlled recovery harness and local structural smoke are complete, but the multi-seed pilot is pending | experimental | 2026-08-18 |
