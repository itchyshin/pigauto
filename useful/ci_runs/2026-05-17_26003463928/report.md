...
Run date: 2026-05-17 22:05:51 (UTC).
...
|avonet    |mass_g                |continuous  |rmse   |lower  |   0.596|   2.726|pigauto |
|avonet    |migration             |ordinal     |acc    |higher |   0.747|   0.819|bace    |
...
|6  |avonet    |primary_lifestyle |categorical |         0.513|      0.318|bace         |
|8  |avonet    |trophic_level     |categorical |         0.461|      0.338|bace         |
...
|4  |avonet    |mass_g                |continuous |       0.952|          2.359|
|7  |avonet    |tarsus_length_mm      |continuous |       0.957|          1.154|
|9  |avonet    |wing_length_mm        |continuous |       0.960|          0.992|
|10 |bien      |height_m              |continuous |       0.828|          4.361|
|11 |bien      |leaf_area             |continuous |       0.967|          8.043|
