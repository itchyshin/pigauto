...
Masked cells: 2258
Wall time: 1539.4 s (fit) + 0.1 s (eval)

## Continuous-family (RMSE, fit scale; log for log_traits)

|trait               |type       |   rmse|
|:-------------------|:----------|------:|
|body_mass_g         |continuous | 0.9067|
|gestation_d         |continuous | 0.3886|
|head_body_length_mm |continuous | 0.3747|
|max_longevity_m     |continuous | 0.5289|
|litter_size         |count      | 1.1285|

## Discrete-family (accuracy)

|trait           |type    | accuracy|
|:---------------|:-------|--------:|
|terrestriality  |binary  |   0.9327|
|diet_breadth    |ordinal |   0.5039|
|habitat_breadth |ordinal |   0.7684|
