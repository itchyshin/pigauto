...
Masked cells: 4197
Wall time: 1390.3 s (fit) + 0.1 s (eval)

## Continuous-family (RMSE, fit scale; log for log_traits)

|trait                 |type       |   rmse|
|:---------------------|:----------|------:|
|beak_length_culmen_mm |continuous | 0.4609|
|mass_g                |continuous | 0.8339|
|tarsus_length_mm      |continuous | 0.4030|
|wing_length_mm        |continuous | 0.5308|

## Discrete-family (accuracy)

|trait             |type        | accuracy|
|:-----------------|:-----------|--------:|
|primary_lifestyle |categorical |   0.3717|
|trophic_level     |categorical |   0.4282|
|migration         |ordinal     |   0.6455|
