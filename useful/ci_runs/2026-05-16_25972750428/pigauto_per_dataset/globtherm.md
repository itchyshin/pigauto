...
Masked cells: 2074
Wall time: 845.9 s (fit) + 0.1 s (eval)

## Continuous-family (RMSE, fit scale; log for log_traits)

|trait         |type       |     rmse|
|:-------------|:----------|--------:|
|elevation_max |continuous | 916.6777|
|lat_max       |continuous |  42.4053|
|long_max      |continuous | 113.5916|
|Tmax          |continuous |   7.5578|
|Tmin          |continuous |   9.2810|
