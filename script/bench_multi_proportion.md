...
- aitchison: Aitchison distance (Euclidean in CLR space).
- rmse_clr: RMSE on z-scored CLR values.
- simplex_mae: MAE on simplex after softmax decode.
- accuracy: argmax accuracy (dominant component match).
...
```
 ...
 baseline  comp  6.424845 1.029778   0.2074157 0.4678363
  pigauto  comp  6.420320 1.031067   0.2055318 0.4619883
```
...
```
 ...
 baseline  comp  4.282956 0.9036986   0.1674832 0.4970760
  pigauto  comp  4.305335 0.9056558   0.1687016 0.5029240
```
...
```
 ...
 baseline  comp  2.622369 0.8745383   0.2573747 0.5263158
  pigauto  comp  2.604217 0.8711380   0.2565978 0.5204678
```
...
```
 ...
 baseline  comp  5.758896 0.8558837   0.1226024 0.3918129
  pigauto  comp  5.789935 0.8586314   0.1233902 0.3801170
```
...
```
 ...
 baseline  comp  7.771377 0.8747852  0.09378061 0.2865497
  pigauto  comp  7.802325 0.8789329  0.09442802 0.3040936
```
