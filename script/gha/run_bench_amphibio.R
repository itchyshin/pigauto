...
#
# CI wrapper for the AmphiBIO bench (BACE-compat).
...
tryCatch({
  load(file.path("useful", "bace_data_snapshot", "data", "amphibio_traits.rda"))
  load(file.path("useful", "bace_data_snapshot", "data", "amphibio_tree.rda"))
  .run_bench_bace_compat(traits_df = amphibio_traits,
                          tree      = amphibio_tree,
                          dataset   = DATASET,
                          out_dir   = OUT_DIR,
