...
# Frequentist results of record come from fir ~/pigauto_rubin_f2 (freq-v2); the earlier freq results are superseded.
...
echo "fir     $(q fir "R=~/pigauto_rubin; $cnt") | freq-v2 $(q fir "R=~/pigauto_rubin_f2; $cnt")"
