...
State 2026-09-24: plan written; Q1-Q3 all YES (Shinichi, "yes yes yes"): BACE + residual-draw arm; freq parametric bootstrap headline + one-fit contrast; PGLS slope c2~c1 + correlation. Step 1 smoke in progress. Next: step 1 smoke (Mac) once Q1-Q3 are answered;
step 2 BACE settings pre-run needs his approval (D-139). Never edit R/ or BACE/. Totoro shared: check free -g first.
